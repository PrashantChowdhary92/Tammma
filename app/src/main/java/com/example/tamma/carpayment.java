...
public class carpayment extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_carpayment);
        ...
        book.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent ntent = new Intent(carpayment.this, successfull.class);
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        switch (id) {
            case R.id.nav_home:
                Intent h = new Intent(carpayment.this, previosbooking.class);
                startActivity(h);
                break;
