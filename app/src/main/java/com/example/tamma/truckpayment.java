...
public class truckpayment extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_truckpayment);
        ...
        book.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent ntent = new Intent(truckpayment.this, successfull.class);
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        switch (id) {
            case R.id.nav_home:
                Intent h = new Intent(truckpayment.this, previosbooking.class);
                startActivity(h);
                break;
